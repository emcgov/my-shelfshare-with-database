...
async function run() {
  ...
  const uri =
    "mongodb+srv://shelfuser:Soccer123@cluster0.smdvj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
  ...
  //    console.log(`${users.name} has ${users.ingredients.length} ingredients and takes ${users.prepTimeInMinutes} minutes to make.`);
  //  });
    // add a linebreak
  //  console.log();
  //} catch (err) {
...
//
  ...
  //    console.log("Couldn't find any userss that contain 'potato' as an ingredient.\n");
  //  } else {
  //    console.log(`Found a users with 'potato' as an ingredient:\n${JSON.stringify(findOneResult)}\n`);
  //  }
  //} catch (err) {
